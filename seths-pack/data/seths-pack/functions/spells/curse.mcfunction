...
execute at @e[tag=curse_anchor] run setblock ~-10 ~ ~10 minecraft:end_gateway{Age:40l}
execute at @e[tag=curse_anchor] run setblock ~-10 ~ ~-10 minecraft:end_gateway{Age:30l}
...
execute as @e[type=!minecraft:player,type=!minecraft:horse,type=!minecraft:cat,type=!minecraft:item,type=!minecraft:experience_orb,type=!minecraft:item_frame,type=!minecraft:tnt,type=!minecraft:villager,type=!minecraft:firework_rocket,type=!minecraft:armor_stand,type=!minecraft:potion,type=!minecraft:leash_knot] at @s if entity @e[tag=curse_scroll, distance=..10] run summon minecraft:lightning_bolt ~ ~ ~
